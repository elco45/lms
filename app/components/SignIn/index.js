...
import { NavItem, NavLink, Button, Modal } from 'mdbreact';
...
class SignIn extends React.Component {
  ...
  renderSignUpModal() {
    return (
      <Modal size="lg" isOpen={this.state.modalSignUp} toggle={this.toggleSignUp} className="roundedModal" key="msu">
            ...
            <ModalRightContainer className="col-md-7 col-sm-12 text-center">
              <div className="row">
                <div className="col-12 text-right">
                  <button onClick={this.toggleSignUp}>X</button>
                </div>
                ...
                {this.renderProviderSignIn()}
                <div className="col-12">
                  <div className="float-left">
                    <ModalTextIsMember> Ya eres Miembro? </ModalTextIsMember>
                    <ModalTextOpenSI onClick={this.toggle}> Inicia Sesión </ModalTextOpenSI>
                  </div>
  ...
  renderSignInModal() {
    return (
      <Modal isOpen={this.state.modalSignIn} toggle={this.toggleSignIn} className="roundedModal" key="msi">
        <div className="container">
          <div className="row">
            <ModalRightContainer className="col-12 text-center">
              <div className="row">
                <div className="col-12 text-right">
                  <button onClick={this.toggleSignIn}>X</button>
                </div>
                <ModalRightTitle className="col-12">Sign In</ModalRightTitle>
                <form className="col-12" style={{ marginBottom: 20, marginTop: 20 }}>
                  <ModalInput type="text" className="form-control" placeholder="Nombre de usuario" />
                  <ModalInput type="text" className="form-control" placeholder="Contraseña" />
                ...
                <div className="col-12">
                  <div className="float-right">
                    ...
                    <ModalTextOpenSI onClick={this.toggle}> Crear cuenta </ModalTextOpenSI>
                  </div>
                </div>
              </div>
            </ModalRightContainer>
  ...
  renderSignUp() {
    return (
      <NavItem key="su">
        <NavLink onClick={this.toggleSignUp} to="#">Crear Cuenta</NavLink>
      </NavItem>
    );
  }
  ...
  renderSignIn() {
    return (
      <NavItem key="si">
        <NavLink onClick={this.toggleSignIn} to="#">Entrar</NavLink>
      </NavItem>
    );
  }
  render() {
